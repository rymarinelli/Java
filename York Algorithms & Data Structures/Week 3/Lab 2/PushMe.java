	...
	{ 
		...
		{ 
			...
			button.setText("Get the number of letters.");
			button.setOnAction(e -> 
			{
				//testOblong.setLength(Double.parseDouble(lengthField.getText()));            

				pushMeLabel.setText(Integer.toString(pushMeTextField.getText().length()));
			...
			root.getChildren().addAll(pushMeTextField, pushMeButton, button, pushMeLabel); 
