...
public class TestAccounts
{
    ...
    //Check balance
     ...
     //Checking InterestAccount.java
     InterestAccount test = new InterestAccount(10000, .25);
     System.out.println(test.getMonthlyInterestRate());
     System.out.println(test.addMonthlyInterest());
     System.out.println(test.toString());
     
     InterestAccount testTwo = new InterestAccount(10000, .1);
     System.out.println(testTwo.getMonthlyInterestRate());
     System.out.println(testTwo.addMonthlyInterest());
